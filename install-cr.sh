...
[[ -z "${INPUT_CR_VERSION}" ]] &&
	fail "INPUT_CR_VERSION enviroment variable is not set!"
...
readonly CR_URL="https://github.com/${CR_HOST_PATH}/${INPUT_CR_VERSION}/${CR_TARBALL}"

readonly TMP_DIR="/tmp"
readonly OUTPUT_DOCUMENT="${TMP_DIR}/${CR_TARBALL}"

phase "Installing chart-releaser '${INPUT_CR_VERSION}'"

# making sure the previous download is removed
[[ -f "${OUTPUT_DOCUMENT}" ]] && rm -fv ${OUTPUT_DOCUMENT}

phase "Downloading chart-releaser tarball '${CR_URL}'"
